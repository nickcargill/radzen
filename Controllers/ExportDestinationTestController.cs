...
namespace Destination.Controllers
{
    public partial class ExportdestinationTestController : ExportController
    {
        ...
        {
            return ToCSV(ApplyQuery(await service.GetAgentStatuses(), Request.Query, false), fileName);
        }
        ...
        {
            return ToExcel(ApplyQuery(await service.GetAgentStatuses(), Request.Query, false), fileName);
        }

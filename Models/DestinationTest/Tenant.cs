...
namespace Destination.Models.destinationTest
{
    ...
    public partial class Tenant
    {
        ...
        [Column("DNRWhy")]
        public string Dnrwhy { get; set; }

        public int? BedsRequested { get; set; }
        ...
        public string DoNotRentType { get; set; }

        public int? PastBookings { get; set; }

        public decimal? PastDollars { get; set; }

        public bool? PlusOneRemovedFromCell { get; set; }

        public bool? FromPage { get; set; }

        public string GuestPrimaryAddress { get; set; }
        ...
        public int? LastVisitedProp { get; set; }

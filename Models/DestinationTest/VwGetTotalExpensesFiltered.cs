...
{
    [Table("vw_getTotalExpensesFiltered", Schema = "dbo")]
    public partial class VwGetTotalExpensesFiltered
    {
        [Column("propid")]
        ...
        [Column("Opened in 123 months")]
        public int? OpenedIn123Months { get; set; }

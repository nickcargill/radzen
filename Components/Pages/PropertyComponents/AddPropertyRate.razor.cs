...
{
    public partial class AddPropertyRate
    {
        [Inject]
        ...
        {
            propertyRate = new Destination.Models.destinationTest.PropertyRate();
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await destinationTestService.CreatePropertyRate(propertyRate);

...
{
    public partial class EditMenuManagement
    {
        [Inject]
        ...
        {
            menuManagement = await destinationTestService.GetMenuManagementById(Id);
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await destinationTestService.UpdateMenuManagement(Id, menuManagement);
